...
import FolderCompressor.ZipFolder;
import static wingph.GphGuiConstants.COMP_LZW;
            ...
            public void run() {
                try {
                    ...
                    switch (falgo) {
                        ...
                        case COMP_ZIP:
                            if (bCompress) {
                                ZipFolder obj = new ZipFolder(iFilename, oFilename);
                                //success = obj.zipFolder();
                                gSummary += obj.getSummary();
